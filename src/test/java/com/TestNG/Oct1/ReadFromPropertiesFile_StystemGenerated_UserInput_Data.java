...
public class ReadFromPropertiesFile_StystemGenerated_UserInput_Data {
	...
	public static void main(String[] args) throws Exception {
		prop = new Properties();
		ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\com\\TestNG\\Oct1\\testdata.properties");
		prop.load(ip);
