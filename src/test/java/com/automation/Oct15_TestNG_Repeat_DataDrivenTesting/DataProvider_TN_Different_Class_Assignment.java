...
public class DataProvider_TN_Different_Class_Assignment {
	
	public WebDriver driver;
	
	
	@Test(dataProvider = "tutorialsNinjaLogin", dataProviderClass = DataProvider_TN_SameClass_Assignment.class)
	public void loginTutorialsNinjaDataProviderDifferentClass(String username, String password) {
